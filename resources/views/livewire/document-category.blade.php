...
@endif
        ...
        <div class="px-4">
            ...
            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800 mt-3"> You may add multiple document categories separated by a comma</span>
        </div>
